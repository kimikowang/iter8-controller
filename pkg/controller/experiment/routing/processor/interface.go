...
// Interface defines functions that a handler should implement
type Interface interface {
	...
	UpdateRouteWithBaseline(instance *iter8v1alpha2.Experiment, targets *targets.Targets)
	// UpdateRouteWithCandidates updates routing rules with runtime objects of candidates
	UpdateRouteWithCandidates(instance *iter8v1alpha2.Experiment, targets *targets.Targets)
	// UpdateRouteWithTrafficUpdate updates routing rules with new traffic state from assessment
	UpdateRouteWithTrafficUpdate(instance *iter8v1alpha2.Experiment)
	// UpdateRouteToStable updates routing rules to desired stable state
	UpdateRouteToStable(instance *iter8v1alpha2.Experiment)
}
